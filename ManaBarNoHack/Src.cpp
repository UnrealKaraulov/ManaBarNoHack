...
unsigned char olda6F37A563[ 6 ];
unsigned char olda6F37A968[ 6 ];
...
void ManaBarInit( )
{
	...
	a6F37A563 = dwGameDll + 0x379AE3;
	a6F37A968 = dwGameDll + 0x379EE8;

	a16F088 = ( DWORD ) GetProcAddress( dwStormDll , ( LPCSTR ) 0x191 );
	a3000AC = 1;
...

	{
		...
		ReadProcessMemory( GetCurrentProcess( ) , ( LPVOID ) a6F37A563 , olda6F37A563 , 5 , 0 );
...

	{
		...
		ReadProcessMemory( GetCurrentProcess( ) , ( LPVOID ) a6F37A968 , olda6F37A968 , 5 , 0 );
...
BOOL WINAPI DllMain( HINSTANCE hDLL , UINT reason , LPVOID reserved )
{
	if ( reason == DLL_PROCESS_ATTACH )
	{
		...
		dwStormDll = GetModuleHandle( "Storm.dll" );
		if ( !dwGameDll || !dwStormDll )
		{
			MessageBox( 0 , "Need inject after game and storm dlls!" , " MANABAR ERROR " , 0 );
			return 1;
		}
	...
	else if ( reason == DLL_PROCESS_DETACH )
	{
		...
		{
			VirtualProtect( ( LPVOID ) a6F37A563 , 5 , PAGE_EXECUTE_READWRITE , &dwOldProtection );
			WriteProcessMemory( GetCurrentProcess( ) , ( LPVOID ) a6F37A563 , olda6F37A563 , 5 , 0 );
			VirtualProtect( ( LPVOID ) a6F37A563 , 5 , dwOldProtection , NULL );
		}

		{
			VirtualProtect( ( LPVOID ) a6F37A968 , 5 , PAGE_EXECUTE_READWRITE , &dwOldProtection );
			WriteProcessMemory( GetCurrentProcess( ) , ( LPVOID ) a6F37A968 , olda6F37A968 , 5 , 0 );
			VirtualProtect( ( LPVOID ) a6F37A968 , 5 , dwOldProtection , NULL );
		}
	}
	return TRUE;
